export default function Features() {
 const features = [
   {
     title: "Find Work",
     description: "We welcome students looking to apply skills to real projects, talents, and skilled freelancers to take up work you are interested and get paid.",
     icon: (
       <path 
         strokeLinecap="round" 
